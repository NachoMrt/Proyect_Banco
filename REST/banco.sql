...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2026 a las 11:29:27
...
INSERT INTO `cuenta` (`id_cuenta`, `tipo_cuenta`, `saldo`, `fecha_apertura`, `id_cliente`) VALUES
(1, 'Ahorro', 1500.5, '2024-01-15', 1),
(2, 'Corriente', 3200.75, '2024-03-10', 2),
(3, 'Ahorro', 500, '2024-06-01', 3);
...
INSERT INTO `transaccion` (`id_transaccion`, `fecha`, `tipo`, `monto`, `id_cuenta`) VALUES
(1, '2024-07-01', 'Deposito', 500.00, 1),
(2, '2024-07-05', 'Retiro', 200.00, 2),
(3, '2024-07-10', 'Deposito', 1000.00, 3);
